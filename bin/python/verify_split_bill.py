...
PRONTO_INTERNAL_SECRET = os.getenv("PRONTO_INTERNAL_SECRET", "120d88e0cea0c97975e99901650132968f1b554c76d16814eeef2c4ce905aa89")

def login():
    """Login as admin and return session."""
    session = requests.Session()
    session.headers.update({
        "X-Pronto-Internal-Auth": PRONTO_INTERNAL_SECRET
    })
...
def create_active_session(session):
    ...
    payload = {
        "items": [
            {"menu_item_id": item_id, "quantity": 1, "modifiers": []}
        ],
        "table_id": "99",
