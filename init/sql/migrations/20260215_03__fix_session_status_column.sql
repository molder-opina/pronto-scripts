...
COMMENT ON COLUMN pronto_dining_sessions.status IS 'Session status: open, active, awaiting_tip, awaiting_payment, awaiting_payment_confirmation, merged, closed, paid';
